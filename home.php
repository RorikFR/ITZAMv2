    ...
    <script>
        document.addEventListener('DOMContentLoaded', async () => {
            try {
                ...
                // Asignamos los valores devueltos a cada tarjeta
                ...
                document.getElementById('kpi-pacientes').textContent = data.pacientes; // Nuevo
                ...
                document.getElementById('kpi-recetas').textContent = data.recetas; // Nuevo
                document.getElementById('kpi-vacunas').textContent = data.vacunas;
                document.getElementById('kpi-personal').textContent = data.personal; // Nuevo
