...
<div class="grid-wrapper">
        <div class="formulario-background-normal">
            <form class="formulario-receta" id="nueva_receta" action="" method="post" novalidate>
                    ...
                    <fieldset id="datos-receta">
						...
						<label for="medico">*Cédula médico:</label>
						<input class="form" type="text" id="cedula" name="cedula" required />

						<label for="prox_consulta">*Próxima consulta:</label>
						<input class="form" type="date" id="prox_consulta" name="prox_consulta" />
					</fieldset>


					<fieldset id="rx-receta">
						<legend>Datos receta</legend>
						<label for="indicaciones">*Indicaciones:</label>
						<textarea id="receta-indicaciones" name="indicaciones"></textarea>
					</fieldset>
            </form>
					<button class="multi-btn-clear" type="button" id="clearBtn">Limpiar campos</button>
					<button type="submit" class="multi-btn-submit">Registrar</button>
        </div>
</div>
