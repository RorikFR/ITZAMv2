        ...
        <div class="formulario-background-normal">
            ...
            <form class="multiform" id="multiStepForm" action="" method="post" novalidate autocomplete="off">
                ...
                <div class="tab active" data-step="0" aria-hidden="false">
                    ...
                    <input class="form" type="text" id="especialidad" name="especialidad"  />  

                    <label for="cedula_especialidad">Cédula de especialidad:</label>
                    <input class="form" type="text" id="cedula_especialidad" name="cedula_especialidad"  />
                    </fieldset>
                </div>
                ...
                <div class="tab" data-step="1" aria-hidden="true">
                    ...
                    <input class="form" type="text" id="email_institucional" name="email_institucional" required />
                 ...
                 <div class="step-controls">
                    ...
                    <button class="multi-btn-submit" type="submit" id="submitBtn">Registrar personal</button>
