...
<div class="grid-wrapper">
        <div class="formulario-background-normal">
            ...
            <form class="multiform" id="multiStepForm" action="" method="post" novalidate>
                ...
                <div class="tab active" data-step="0" aria-hidden="false">
                    ...
                    <input class="form" type="date" id="fecha_nacimiento" name="fecha_nacimiento" required />
                ...
                <div class="tab" data-step="1" aria-hidden="true">
                    ...
                    <input class="form" type="number" id="numero" name="numero" required />
                    ...
                    <input class="form" type="tel" id="telefono" name="telefono" />
                ...
                <div class="step-controls">
                    ...
                    <button class="multi-btn-submit" type="submit" id="submitBtn">Registrar paciente</button>
