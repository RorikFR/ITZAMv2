...
<div class="grid-wrapper">
    <div class="formulario-background-normal">
        ...
        <form class="multi-form" id="multiStepForm" action="" method="post" novalidate>
            ...
            <div class="tab active" data-step="0" aria-hidden="false">
                <fieldset id="datos">
                            ...
                            <select class="form" id="tipo_consulta" name="tipo_consulta" required>
                                ...
                                <option value="primera_vez">Consulta general</option>
                                <option value="subsecuente">Urgencias</option>
                                <option value="urgencia">Consulta dental</option>
                                <option value="dental">Consulta de especialidad</option>
                                <option value="especialidad">Consulta de seguimiento </option>
                                <option value="seguimiento">Consulta de maternidad</option>
                            </select>
                            ...
                            <input class="form" type="number" id="peso" name="peso" required />

                            <label for="talla">Talla (cm):</label>
                            <input class="form" type="number" id="talla" name="talla" required />
                </fieldset>
                ...
                <fieldset id="signos">
                            ...
                            <input class="form" type="number" id="temperatura" name="temperatura" required />

                            <label for="frecuencia">*Frecuencia cardiaca (lpm):</label>
                            <input class="form" type="number" id="frecuencia" name="frecuencia" required />

                            <label for="saturacion">*Saturación de oxígeno (%):</label>
                            <input class="form" type="number" id="saturacion" name="saturacion" required />

                            <label for="presion_arterial">*Presión arterial (mmHg):</label>
                            <input class="form"type="text" id="presion_arterial" name="presion_arterial" required />
                </fieldset>
            </div>
            ...
            <div class="tab" data-step="1" aria-hidden="true">
                <fieldset id="sintomas">
                    ...
                    <input class="form" type="date" id="inicio_sintomas" name="inicio_sintomas" required />

                    <label for="sintomas">*Síntomas:</label>
                    <textarea id="consulta-sintomas" name="sintomas" required></textarea>
                </fieldset>

                <fieldset id="antecedentes">
                    <legend>Antecedentes</legend>
                    <label for="alergias">*Alergias:</label>
                    <input class="form" type="text" id="alergias" name="alergias" required />

                    <label for="antecedentes">*Antecedentes familiares:</label>
                    <input class="form" type="text" id="antecedentes" name="antecedentes" required />

                    <label for="habitos">*Hábitos:</label>
                    <input class="form" type="text" id="habitos" name="habitos" required />
                </fieldset>
            </div>
            ...
            <div class="tab" data-step="2" aria-hidden="true">
                    ...
                    <textarea id="consulta-diagnostico" name="diagnostico" required></textarea>
            </div>

            <!-- Step 4 -->
            <div class="tab" data-step="3" aria-hidden="true">
					<label for="tratamiento">*Tratamiento:</label>
                    <textarea id="consulta-tratamiento" name="tratamiento" required></textarea>
            </div>
        </form>
        ...
        <div class="step-controls">
            ...
            <button class="multi-btn-submit" type="submit" id="submitBtn">Registrar consulta</button>
